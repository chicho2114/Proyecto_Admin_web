                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-file-text-o"></i>  Crear Usuario
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="panel-body form-horizontal payment-form">                  
	                    <form method="POST" action="gestionar_usuario.php">
						    ...
						    <div class="form-group">
						      ...
						      <input class="form-control" type="numeric" name="cedula" id="cedula" required/>
						    </div>
						    <div class="form-group">
						    ...
						    <div class="form-group">
						      ...
						      <input class="form-control" type="numeric" name="telefono" id="telefono" required />
						    </div>
